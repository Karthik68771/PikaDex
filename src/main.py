...
@app.on_message(Filters.command(['stats', 'stats@PikaDexBot']))
...
# ===== Home =====
@app.on_message(Filters.command(['start', 'start@PikaDexBot']))
...
# ==== Type Pokemon =====
@app.on_message(Filters.command(['type', 'type@PikaDexBot']))
...
@app.on_message(Filters.command(['types', 'types@PikaDexBot']))
...
@app.on_message(Filters.command(['ptype', 'ptype@PikaDexBot']))
...
@app.on_message(Filters.command(['data', 'data@PikaDexBot']))
def pkmn_search(app, message):
    try:
        if message.text == '/data' or message.text == '/data@PikaDexBot':
...
@app.on_message(Filters.command(['usage', 'usage@PikaDexBot']))
...
# ===== FAQ command =====
@app.on_message(Filters.command(['faq', 'faq@PikaDexBot']))
def faq(app, message):
    text = texts['faq']
    app.send_message(
        chat_id=message.chat.id,
...
# ===== About command =====
@app.on_message(Filters.command(['about', 'about@PikaDexBot']))
...
# ===== Raid commands =====
@app.on_message(Filters.command(['addcode', 'addcode@PikaDexBot']))
def call_add_fc(app, message):
    raid.add_fc(app, message, texts)

@app.on_message(Filters.command(['mycode', 'mycode@PikaDexBot']))
def call_show_my_fc(app, message):
    raid.show_my_fc(app, message, texts)

@app.on_message(Filters.command(['newraid', 'newraid@PikaDexBot']))
